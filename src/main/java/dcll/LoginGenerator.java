...
public class LoginGenerator {
     ...
     * @param loginServic le service de login.
     */
    public LoginGenerator(final LoginService loginServic) {
        this.loginService = loginServic;
    }
    ...
    public final String generateLoginForNomAndPrenom(final String nom,
        ...
        final int zero = 0;
        final int un = 1;
        String p = deAccent(prenom.substring(zero, un).toUpperCase());
        String n = deAccent(nom.substring(zero, trois).toUpperCase());
        String login = p + n;
